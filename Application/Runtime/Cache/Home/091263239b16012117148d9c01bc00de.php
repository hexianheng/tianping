...
<div class="left_slide_nav">
  <div class="business">
      <dl class="dl_list">
          ...
          <dd><a href="<?php echo ($url); ?>/Index/xzgly" target="rightFrame">新增用户</a></dd>
          <dd><a href="<?php echo ($url); ?>/Index/gly_list" target="rightFrame">用户列表</a></dd>
          ...
          <dd><a href="<?php echo ($url); ?>/Index/qxlb" target="rightFrame">权限列表</a></dd>
      ...
      <dl class="dl_list">
          ...
          <dd><a href="<?php echo ($url); ?>/Index/bm_list" target="rightFrame">编码列表</a></dd>
          <dd><a href="<?php echo ($url); ?>/Index/xzbmy" target="rightFrame">编码分组</a></dd>
