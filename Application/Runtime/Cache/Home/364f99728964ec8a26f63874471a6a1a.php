...
<div class="fill-info">
    <div class="right">
        <a class="btn02" id="xg_btn" href="js_list.html">角色列表</a>
    <div class="info-box">
      <ul>
        <li>
          <label>角色名称：</label>
          <input type="text" name="name" class="w200 name" id="roleName" value="">
        </li>
         <li>
              <label>请选择权限：</label>
    ...
    <div class="preview">
        <a class="preview-btn btn01" id="btn">保存</a>
    </div>
  </div>
</div>
      </div>
...
<script type="text/javascript" src="/gitjob/Public/js_logic/xzjs.js"></script>